...
const PETAL_DATA: PetalData[] = [
  { id: 1, left: "4%", size: 14, duration: 8.5, delay: 0.2, color: "#F6C1CB", opacity: 0.8, shapeType: 0, animName: "petalFallA" },
  { id: 2, left: "11%", size: 11, duration: 9.8, delay: 3.4, color: "#C88D94", opacity: 0.75, shapeType: 1, animName: "petalFallB" },
  { id: 3, left: "19%", size: 16, duration: 7.6, delay: 1.1, color: "#E6C594", opacity: 0.85, shapeType: 0, animName: "petalFallC" },
  { id: 4, left: "27%", size: 10, duration: 11.2, delay: 5.8, color: "#9CAF88", opacity: 0.7, shapeType: 2, animName: "petalFallA" }, // tiny leaf
  { id: 5, left: "34%", size: 13, duration: 8.9, delay: 2.3, color: "#FFF6EF", opacity: 0.8, shapeType: 3, animName: "petalFallB" },
  { id: 6, left: "42%", size: 15, duration: 10.4, delay: 6.7, color: "#FCD5CE", opacity: 0.85, shapeType: 0, animName: "petalFallC" },
  { id: 7, left: "50%", size: 12, duration: 7.9, delay: 0.8, color: "#EAA0B0", opacity: 0.75, shapeType: 1, animName: "petalFallA" },
  { id: 8, left: "57%", size: 17, duration: 9.2, delay: 4.1, color: "#B86B77", opacity: 0.8, shapeType: 4, animName: "petalFallB" },
  { id: 9, left: "65%", size: 11, duration: 11.8, delay: 1.9, color: "#8A9A86", opacity: 0.7, shapeType: 2, animName: "petalFallC" }, // tiny leaf
  { id: 10, left: "72%", size: 14, duration: 8.2, delay: 5.2, color: "#D8B27B", opacity: 0.85, shapeType: 0, animName: "petalFallA" },
  { id: 11, left: "80%", size: 16, duration: 10.1, delay: 2.7, color: "#F6C1CB", opacity: 0.8, shapeType: 3, animName: "petalFallB" },
  { id: 12, left: "88%", size: 12, duration: 7.4, delay: 0.5, color: "#FCD5CE", opacity: 0.75, shapeType: 1, animName: "petalFallC" },
  { id: 13, left: "94%", size: 15, duration: 9.5, delay: 6.1, color: "#C88D94", opacity: 0.85, shapeType: 4, animName: "petalFallA" },
  { id: 14, left: "15%", size: 13, duration: 12.0, delay: 7.5, color: "#FFF6EF", opacity: 0.7, shapeType: 0, animName: "petalFallB" },
  { id: 15, left: "83%", size: 10, duration: 8.8, delay: 8.3, color: "#9CAF88", opacity: 0.7, shapeType: 2, animName: "petalFallC" }, // tiny leaf
];
...
function PetalSvg({ shapeType, color }: { shapeType: number; color: string }) {
  switch (shapeType) {
    case 0:
      // Teardrop Rose Petal
      return (
        <svg viewBox="0 0 24 24" fill={color} className="w-full h-full drop-shadow-[0_1px_2px_rgba(0,0,0,0.06)]">
    ...
    case 2:
      ...
      return (
        <svg viewBox="0 0 24 24" className="w-full h-full drop-shadow-[0_1px_2px_rgba(0,0,0,0.06)]">
          <path fill={color} d="M12 2C7.5 6 5.5 11 5.5 15.5C5.5 19 8 21.5 12 22C16 21.5 18.5 19 18.5 15.5C18.5 11 16.5 6 12 2Z" />
          <path d="M12 4.5V19.5" stroke="rgba(255,255,255,0.4)" strokeWidth="1" strokeLinecap="round" />
        </svg>
      );
    case 3:
